			...
			<div class="container-fluid">
				...
				<div class="col-md-3" style="padding-top:20px">
					...
					<ol class="list-inline">
						...
						<li><a href="${pageContext.request.contextPath}/order/findNoPaidOrderByUid.do">购物车</a></li>
						<li><a href="${pageContext.request.contextPath}/order/findMyOrdersWithPage.do?num=1">我的订单</a></li>
					</ol>
					</c:if>
				</div>
			</div>
				...
				<nav class="navbar navbar-inverse">
					<div class="container-fluid">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="/store_web/product/findAllProduct.do?num=1">首页</a>
						</div>
