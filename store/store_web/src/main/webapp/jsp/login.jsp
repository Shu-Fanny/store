...
<div class="row"> 
	...
	<div class="col-md-5">
				...
				<font>会员登录</font>USER LOGIN
					<div style="color: red;font-weight: bold;font-size: 15px">${requestScope.msg}</div><br>
<form class="form-horizontal" action="${pageContext.request.contextPath}/user/userLogin.do" method="post">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    height:35px;width:100px;color:white;">
		...
		<a  value="注册" href="${pageContext.request.contextPath}/jsp/register.jsp">注册</a>
    </div>
  </div>
</form>
</div>			
