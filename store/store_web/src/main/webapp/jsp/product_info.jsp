		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
				  ...
				  <form id="myForm" method="post" action="${pageContext.request.contextPath}/order/addCartItemByUid.do">
					<div class="col-md-6">
					...
					<div class="col-md-6">
					    <!-- 
					     ...
					     -->
						<div><strong>商品名：${product.pname}</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>编号:${product.pid}</div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${product.price}元/份</strong> </del>
						</div>
