								...
								<c:forEach items="${pageModel.list}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.statu==1}">已付款 &nbsp;&nbsp; &nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/adminOrder/updateOrderStatuByOid.do?statu=2&oid=${o.oid}" style="color: red" >点击发货</a>
												</c:if>
...
$(function(){
	...
	$(".myClass").click(function(){
		...
		if(txt=="订单详情"){
			...
			var url="/store_web/adminOrder/findOrderItemsByOid.do";
			var obj={"oid":id};
			$.post(url,obj,function(data){
				...
				$.each(data,function(i,obj){
					var td="<tr><td><img src='/store_web/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.price+"</td><td>"+obj.quantity+"</td></tr>";
					$tb.append(td);				
				})
			},"json");
