								...
								<c:forEach items="${pageModel.list}" var="p" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminPro/findProductByPid.do?pid=${p.pid}">
											...
											<td align="center" style="HEIGHT: 22px">
												<%--下架 pushdown --%>
												<a href="${pageContext.request.contextPath}/adminPro/deleteProductByPid.do?pid=${p.pid}">
